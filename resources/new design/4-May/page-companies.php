...
<main class="page">
    <div class="block main-block">
        <div class="content">
            ...
            <div class="top-menu">
                <div class="button button-green pop-up-opener" data-pop-up-id="add-company-pop-up">Create a New Company</div>
            ...
            <table class="common-table">
                ...
                <tr class="active">
                    ...
                    <td>1203</td>
                    <td>12 / 11 / 2017</td>
                    <td class="edit"><img src="images/pencil.svg" alt="" class="pop-up-opener" data-pop-up-id="edit-company-pop-up"></td>
                </tr>
                <tr class="active">
