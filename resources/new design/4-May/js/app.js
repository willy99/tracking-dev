...
document.addEventListener('DOMContentLoaded', function () {
                ...
                if(subtitle){
                    subtitle.addEventListener('click', function () {
                        ...
                        if(fieldset.classList.contains('hidden')){
                            $(fieldset).find('.tree').hide(300);
                        }else{
                            $(fieldset).find('.tree').show(300);
                        }
                    })
                }
            });
    ...
    if(document.querySelector('.tree')){
        (function () {
            $('.sub-tree-title').click(function () {
                $(this).closest('.tree-item').toggleClass('opened').find('>.sub-tree').toggle(300);
            });
        })();
    }
    ...
    if(document.getElementById('page-login')){
        ...
        if(pageHeight < window.innerHeight){
            var headerHeight = document.querySelector('.login-header-wrap').getBoundingClientRect().height,
                footerHeight = document.querySelector('.footer-wrap').getBoundingClientRect().height;
            document.getElementById('page-login').style.height = window.innerHeight - headerHeight - footerHeight + 'px';
        }
    }
