CREATE DATABASE  IF NOT EXISTS `sotrackc_tracking` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `sotrackc_tracking`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: 138.201.128.230    Database: sotrackc_tracking
-- ------------------------------------------------------
...
CREATE TABLE `authenticated_user` (
  ...
  CONSTRAINT `fk_auth_user` FOREIGN KEY (`user_id`) REFERENCES `tracking_user` (`id`)
...
INSERT INTO `container_type` VALUES (1,'20’ DV',20),(2,'40’ DV',40),(3,'40’ HC',40),(4,'20’ RF',20),(5,'40’ RF',40),(6,'20’ OT',20),(7,'40’ OT',40),(8,'20’ FR',20),(9,'40’ FR',40),(10,'20’ TC',20);
...
INSERT INTO `driver` VALUES (1,'Валера','Дыня','ВН3999??','??67766','09688800022',0,NULL),(3,'Бублик','Дырявый','ВВ8898РР','??67766','09688800022',0,NULL),(4,'Шкандылябрик','Корявый','АО7888ОО','??67766','09688800022',0,NULL);
/*!40000 ALTER TABLE `driver` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `job_status_info`
--

DROP TABLE IF EXISTS `job_status_info`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `job_status_info` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `FK_hvhw4d5opit5sdu09s7axsx8q` FOREIGN KEY (`enabled_by`) REFERENCES `tracking_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `job_status_info`
--

LOCK TABLES `job_status_info` WRITE;
/*!40000 ALTER TABLE `job_status_info` DISABLE KEYS */;
/*!40000 ALTER TABLE `job_status_info` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `order_details` (
  ...
  CONSTRAINT `transaction_details_container_fk` FOREIGN KEY (`container_type`) REFERENCES `container_type` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `transaction_details_driver_fk` FOREIGN KEY (`driver`) REFERENCES `driver` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `transaction_details_fk` FOREIGN KEY (`tracking_order`) REFERENCES `tracking_order` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `order_workflow` (
  ...
  CONSTRAINT `transaction_workflow_fk` FOREIGN KEY (`tracking_order`) REFERENCES `tracking_order` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `order_workflow` VALUES (1,10,'REGISTERED','2017-01-22 06:00:00'),(2,10,'TRANSPORTING','2017-01-23 06:00:00'),(3,10,'DELIVERED','2017-01-26 06:00:00'),(4,11,'REGISTERED','2017-01-22 06:00:00'),(5,11,'TRANSPORTING','2017-05-26 14:33:27'),(6,11,'DELIVERED','2017-02-26 06:00:00');
...
INSERT INTO `terminal` VALUES (1,'Yuzhny','Petrova 12','Yuzhny','Ukraine'),(2,'GPK','Bocharova 33','Odessa','Ukraine');
/*!40000 ALTER TABLE `terminal` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tracking_line`
--

DROP TABLE IF EXISTS `tracking_line`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tracking_line` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `tracking_line`
--

LOCK TABLES `tracking_line` WRITE;
/*!40000 ALTER TABLE `tracking_line` DISABLE KEYS */;
INSERT INTO `tracking_line` VALUES (1,'ZIM'),(2,'Happag-Lloyd'),(3,'Yang Ming '),(4,'UASC'),(5,'SEAGO'),(6,'Evergreen'),(7,'OOCL'),(8,'MSC'),(9,'MOL'),(10,'MAERSK'),(11,'HMM'),(12,'COSCO'),(13,'CMA CGM'),(14,'Arkas'),(15,'APL'),(16,'ANL'),(17,'Admiral'),(18,'TURKON');
/*!40000 ALTER TABLE `tracking_line` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tracking_order` (
  ...
  CONSTRAINT `transaction_client_fk` FOREIGN KEY (`client`) REFERENCES `tracking_user` (`id`),
  CONSTRAINT `transaction_line_fk` FOREIGN KEY (`tracking_line`) REFERENCES `tracking_line` (`id`),
  CONSTRAINT `transaction_terminal_fk` FOREIGN KEY (`terminal`) REFERENCES `terminal` (`id`)
...
LOCK TABLES `tracking_order` WRITE;
/*!40000 ALTER TABLE `tracking_order` DISABLE KEYS */;
INSERT INTO `tracking_order` VALUES (2,'34oifj3904fj34',1,1,'Dolls','2017-03-14 00:00:00',7),(3,'34fj304mfopk;l',2,1,'Bells','2017-03-04 00:00:00',7),(4,'af3e434f3434f',2,1,'Dolls','2017-03-12 00:00:00',7),(5,'asdfasdf3f334f3',1,1,'?????','2017-03-12 00:00:00',7),(10,'asf34f34f34f1',1,1,'Bells','2017-03-21 00:00:00',6),(11,'asf34f34f34f2',2,1,'Bells','2017-03-21 00:00:00',6),(12,'34f34fd14c3',1,1,'Dolls','2017-03-21 00:00:00',6);
/*!40000 ALTER TABLE `tracking_order` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tracking_permission`
--
...
--
-- Dumping data for table `tracking_permission`
--

LOCK TABLES `tracking_permission` WRITE;
/*!40000 ALTER TABLE `tracking_permission` DISABLE KEYS */;
INSERT INTO `tracking_permission` VALUES (3,'SHOW_ORDERS','Show all orders'),(4,'SHOW_DETAILS','Show details on order'),(5,'SHOW_WORKFLOW','Show the workflow'),(6,'SHOW_DICTIONARIES','Show dictionaries'),(7,'SHOW_ROLES','Role Management'),(8,'SHOW_USERS','User Management'),(9,'SHOW_STATUS','Status page'),(10,'LOGIN_APP','Login availability to site'),(11,'JOB_STATUS','The page with jobs'),(12,'SHOW_SYSTEM_CONFIG_MANAGEMENT','System configuration'),(13,'SHOW_SYSTEM_MONITORING','System monitoring and tests');
/*!40000 ALTER TABLE `tracking_permission` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tracking_role`
--

DROP TABLE IF EXISTS `tracking_role`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tracking_role` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `tracking_role`
--

LOCK TABLES `tracking_role` WRITE;
/*!40000 ALTER TABLE `tracking_role` DISABLE KEYS */;
INSERT INTO `tracking_role` VALUES (1,'System Admin','N'),(2,'User','Y'),(8,'New Role','Y'),(10,'Manager','N');
/*!40000 ALTER TABLE `tracking_role` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tracking_role_tracking_permission`
--

DROP TABLE IF EXISTS `tracking_role_tracking_permission`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tracking_role_tracking_permission` (
...
--
-- Dumping data for table `tracking_role_tracking_permission`
--

LOCK TABLES `tracking_role_tracking_permission` WRITE;
/*!40000 ALTER TABLE `tracking_role_tracking_permission` DISABLE KEYS */;
INSERT INTO `tracking_role_tracking_permission` VALUES (1,3),(2,3),(10,3),(1,4),(2,4),(10,4),(1,5),(2,5),(10,5),(1,6),(10,6),(1,7),(10,7),(1,8),(10,8),(1,9),(8,9),(10,9),(1,10),(8,10),(10,10),(8,11),(10,11),(10,12),(10,13);
/*!40000 ALTER TABLE `tracking_role_tracking_permission` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tracking_site`
--

DROP TABLE IF EXISTS `tracking_site`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tracking_site` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `tracking_user` VALUES (1,'WILLY2005@GMAIL.COM','WILLY2005@GMAIL.COM','WILLY2005@GMAIL.COM','Y','2017-03-28 18:19:44','3b612c75a7b5048a435fb6ec81e52ff92d6d795a8b5a9c17070f6a63c97a53b2','+380938513201','en_us'),(2,'test@example.com','Test','Test','N','2017-03-28 18:19:54','3b612c75a7b5048a435fb6ec81e52ff92d6d795a8b5a9c17070f6a63c97a53b2','+380935563311','en_US'),(3,'TEST3@EXAMPLE.COM','test3','test3','N','2017-03-28 18:20:22','70c89eebbe7d46d4eb807438f5e5fae6c56b01b45620f9ee5939c61c275e9d4f','+380565333222','en_US'),(4,'FIRST@EXAMPLE.COM','First','Last','N','2017-03-28 18:20:24','d6e3a8f3a4367b032963b07ff374c8f018259c0cc3584ae40ac4fb7f6ffcf6da','+306639394833','en_US'),(6,'OMSD@LIST.RU','Влад','Олесюк','Y','2017-06-07 20:09:47','3b612c75a7b5048a435fb6ec81e52ff92d6d795a8b5a9c17070f6a63c97a53b2','+380675573108','en_US'),(7,'OMIHAZ@GMAIL.COM','Vlad','Shvaydetsky','Y','2017-04-18 14:56:07','a0ec06301bf1814970a70f89d1d373afdff9a36d1ba6675fc02f8a975f4efaeb','+380936995666','en_us');
/*!40000 ALTER TABLE `tracking_user` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tracking_user_role`
--

DROP TABLE IF EXISTS `tracking_user_role`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tracking_user_role` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `user_id` int(10) NOT NULL,
  ...
  CONSTRAINT `fk_user_role_role` FOREIGN KEY (`role_id`) REFERENCES `tracking_role` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_user_role_user` FOREIGN KEY (`user_id`) REFERENCES `tracking_user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tracking_user_role`
--

LOCK TABLES `tracking_user_role` WRITE;
/*!40000 ALTER TABLE `tracking_user_role` DISABLE KEYS */;
INSERT INTO `tracking_user_role` VALUES (1,1,1),(3,2,2),(5,3,8),(6,3,1),(7,4,8),(8,4,2),(9,4,1),(13,6,1),(14,7,1);
/*!40000 ALTER TABLE `tracking_user_role` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-07-17 23:27:52
