...
<#assign page_title = "Batch Export Flex">
<#include "*/header.ftl"/>
...
<main class="page" ng-controller="flexController">
    ...
    <div class="block main-block">
        ...
        <div class="content w-640">
            <img src="${contextPath}/img/flex/exportformat.png">
            <br><br>
            <form name="batchForm" class="css-form" enctype="multipart/form-data">
                <div class="fieldset visible">

                    <div>Please attach file (For Export): </div>
                    <!--div>
                        <input class="input" type="text" id="order" ng-model="order" ng-required="true">
                    </div-->
                    <div>
...
<script language="JavaScript">
    app.controller("flexController", function($scope, $filter, $http, $q, NgTableParams) {
        ...
        $scope.upload = function () {
            ...
            $http.post('${contextPath}/webresources/flex/executeBatchExportFlex', fd, {
